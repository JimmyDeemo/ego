...
/// <summary>
/// Static only class designed as a collection for game settings.
/// The motivation behind this class is to provide a central location to tweak
/// game variable when balancing gameplay.
/// </summary>
