...
public class GameSettings
{
	...
	public static int PLAYER_BULLET_POOL_SIZE = 20;
	...
	public static float ENEMY_RATE_OF_SPAWN_MIN = 0.6f; //In seconds.
	public static float ENEMY_RATE_OF_SPAWN_MAX = 1.2f; //In seconds.
